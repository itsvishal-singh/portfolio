...
const Social=()=>{
    const socialIcons=socialLinks.map((socialLink, index)=>{
       ...
       <div  data-aos-duration="800" className="aos-init aos-animate"> <socialLink.icon stroke={1.5} className="-rotate-90" size={25} /></div>
    </a>
    })

    return <div  className="flex md-mx:hidden text-textColor items-center gap-10 fixed bottom-32 -left-32 rotate-90 " >
        {socialIcons}
