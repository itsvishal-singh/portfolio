...
return (
    <nav className={`flex ${show?"translate-y-0":"-translate-y-28"} ${shadow?"shadow-[0px_10px_30px_-10px_#020c1b]":""} flex w-full z-30 bg-bgColor h-24  px-10 justify-between items-center xs-mx:px-4 xs-mx:h-20 `}>
